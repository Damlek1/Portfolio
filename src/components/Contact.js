...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-max bg-[#0a192f] flex justify-center items-center p-4 text-white'>
...
export default Contact
  ...
  //         <div className='pb-8'>
  //             <p className='text-4xl font-bold inline border-b-4 border-pink-500 text-gray-300'>Contact</p>
  //             <p className='text-gray-300 py-4'>{'// Submit the form below or send me an email -'}<a href='mailto:ajayioluwasegun111@gmail.com'>ajayioluwasegun111@gmail.com</a></p>
  //         </div>
  //         <input className='bg-[#ccd6f6] p-2 outline-none'  type="text" placeholder='Your Name...*' name='name' required />
  //         <input className='my-4 p-2 bg-[#ccd6f6] outline-none' type="email" placeholder='Your Email...*' name='email' required/>
  //         <textarea className='bg-[#ccd6f6] p-2 outline-none' name='message' rows='10' placeholder='Your message' style={{resize: 'none'}} required></textarea>
